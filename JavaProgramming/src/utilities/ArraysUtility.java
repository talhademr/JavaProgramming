...
public class ArraysUtility {
    ...
    //prints each double of an double array in lines
    ...
    //prints each char of an char array in lines
    ...
    //prints each String of an String array in lines
    ...
    // returns the maximum number for integar array
    ...
    public static int [] replace (int [] array, int index, int newElement){
        ...
        if(index<0 || index> array.length-1){
            System.err.println("Invali index: "+ index);
            System.exit(0);
        }
